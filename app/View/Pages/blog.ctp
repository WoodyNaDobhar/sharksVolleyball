	...
	<div id="page-title">
		...
		<div id="page-title-inner">
			...
			<div class="container">
				...
				<h2><i class="ico-pencil ico-white"></i>Blog</h2>
				...
				<div class="span9">
					...
					<div class="post">
						...
						<div class="post-content">
							<div class="post-title"><h2><a href="post.html">Post title</a></h2></div>
					...
					<!-- start: Post -->
					<div class="post">
						<div class="flex-video"><iframe src="http://player.vimeo.com/video/47995280?portrait=0&color=ffffff" width="500" height="281" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div>
						<span class="post-icon video"><i class="ico-film circle"></i></span>
						<div class="post-content">
							<div class="post-title"><h2><a href="post.html">Video Post</a></h2></div>
							<div class="post-description">
								<p>
									Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.
								</p>
					...
					<div class="post">
						...
						<span class="post-icon standard"><i class="ico-camera circle"></i></span>
						<div class="post-content">
							<div class="post-title"><h2><a href="post.html">Picture Gallery</a></h2></div>
							<div class="post-description">
								<p>
									Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat. Duis autem vel eum iriure dolor in hendrerit in vulputate velit esse molestie consequat, vel illum dolore eu feugiat nulla facilisis at vero eros et accumsan et iusto odio dignissim qui blandit praesent luptatum zzril delenit augue duis dolore te feugait nulla facilisi.
								</p>
