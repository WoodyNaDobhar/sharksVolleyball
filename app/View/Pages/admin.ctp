				...
				<div class="span2">
					<div class="actions">
						...
						<ul>
							...
							<li><?php echo $this->Html->link(__('Practice Schedule'), array('controller' => 'Practices', 'action' => 'index')); ?> </li>
							...
							<li><?php echo $this->Html->link(__('Edit Additional Info'), array('controller' => 'Teampages', 'action' => 'view')); ?> </li>
